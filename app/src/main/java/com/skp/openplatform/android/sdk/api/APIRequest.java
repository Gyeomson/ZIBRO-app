...
public class APIRequest implements APIRequestInterface {
	 ...
	 * @return
	 */
	private HttpUriRequest requestPost(RequestBundle requestBundle) throws java.io.IOException{

		HttpPost httpPost = new HttpPost(urlConverter(requestBundle));

		StringEntity stringEntity = new StringEntity(requestBundle.getPayload(), "UTF-8");
...
//		httpHeader.put("Content-Type", "multipart/form-data");
	 ...
	 * @return
	 */
	private HttpUriRequest requestPut(RequestBundle requestBundle) throws java.io.IOException{
